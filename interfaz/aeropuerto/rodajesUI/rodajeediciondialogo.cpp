...
void RodajeEdicionDialogo::configurarWidgets()
{
    ...
    connect(btnsEdicionRodaje, QOverload<int>::of(&QButtonGroup::buttonPressed), vista, &RodajeEdicionVista::slotSetModEdicion);
    connect(btnsEdicionRodaje, QOverload<int>::of(&QButtonGroup::buttonPressed), this, &RodajeEdicionDialogo::slotModoEdicionCambiado);
